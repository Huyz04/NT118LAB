...
public class EmployeeAdapter7  extends  RecyclerView.Adapter<EmployeeAdapter7.EmployeeHolder>{
    private Activity context=null;
    private int layoutID;
    private List<Employee> mListEmployee=null;

    public EmployeeAdapter7(Activity context, int layoutID, List<Employee> mListEmployee) {
